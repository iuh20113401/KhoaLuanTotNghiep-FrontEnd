  ...
  return (
    <div>
      ...
      <DiemDanhContext.Provider value={{ danhSachSinhVien, loai }}>
        <div className="mt-3">
          <Button onClick={() => setIsDiemDanh(true)}>Tạo mã điểm danh</Button>
          {isDiemDanh && <TaoMaDiemDanhCanvas setIsDiemDanh={setIsDiemDanh} />}
        </div>
        <Card className="mt-3 p-3">
          <h6>Thông tin điểm danh</h6>
          {isLoading ? <LoadingSpinner /> : <DanhSachDIemDanh />}
        </Card>
