...
function TaoMaDiemDanhThucTapCanvas({ setIsDiemDanh }) {
  ...
  const DanhSachSinhVien = data?.results;
        ...
        <StyledForm onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            >
              ...
              <option value={"sinhVien"}>Theo sinh viên</option>
            </StyledSelect>
          </div>
          <div>
...
export default TaoMaDiemDanhThucTapCanvas;
